...
for city in cities:
    # Load the entire pipeline (PolynomialFeatures + LinearRegression)
    model = joblib.load(f'models/polynomial_regression/{city}_polynomial_model.pkl')
    models[city] = model
...
# Save the models
joblib.dump(gb_model, 'models/combines/gradient_boosting_model_pol_reg.pkl')
